...
class AddOrderViewModel(): ViewModel() {
    ...
    private val listWorkerDays: List<WorkerDay> = listOf(
        ...
        WorkerDay("4", 0,timeList2),
        WorkerDay("5", 0,null),
        WorkerDay("6", 0,null),
        WorkerDay("7", 1,timeList1),
        WorkerDay("8", 0,null),
        WorkerDay("9", 0,timeList2),
        WorkerDay("10", 0,timeList2),
        WorkerDay("11", 0,null),
        WorkerDay("12", 1,timeList1),
        WorkerDay("13", 0,null),
        WorkerDay("14", 0,timeList2),
        ...
        WorkerDay("21", 0,timeList2),
        WorkerDay("22", 0,null),
        WorkerDay("23", 1,timeList1),
        WorkerDay("24", 0,null),
        WorkerDay("25", 0,timeList2),
        WorkerDay("26", 0,null),
        WorkerDay("27", 1,timeList1),
        WorkerDay("28", 0,null),
        WorkerDay("29", 0,timeList2),
        WorkerDay("30", 0,timeList2),
        WorkerDay("31", 0,timeList2),
        WorkerDay("", 0,null),
        WorkerDay("", 0,null),
        WorkerDay("", 0,null),
        WorkerDay("", 0,null),
